...
SENSITIVE=(DB_PASSWORD REDIS_PASSWORD JWT_PRIVATE_KEY JWT_PUBLIC_KEY TWITCH_CLIENT_SECRET STRIPE_SECRET_KEY STRIPE_WEBHOOK_SECRET STRIPE_WEBHOOK_SECRET_ALT STRIPE_WEBHOOK_SECRETS OPENAI_API_KEY SENDGRID_API_KEY OPENSEARCH_PASSWORD)
