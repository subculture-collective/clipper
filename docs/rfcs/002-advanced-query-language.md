...
- [RFC 002: Advanced Query Language](#rfc-002-advanced-query-language)
  - [Summary](#summary)
  - [Context](#context)
  - [Goals](#goals)
  - [Non-Goals](#non-goals)
  ...
  - [Edge Cases and Validation](#edge-cases-and-validation)
    ...
    - [Invalid Filter Names](#invalid-filter-names)
    - [Invalid Filter Values](#invalid-filter-values)
    - [Quote Mismatches](#quote-mismatches)
  ...
  - [Implementation Notes](#implementation-notes)
    ...
    - [Translation to Backend Queries](#translation-to-backend-queries)
    - [Auto-complete Support](#auto-complete-support)
    - [URL Encoding](#url-encoding)
  - [Migration Strategy](#migration-strategy)
    - [Phase 1: Backward Compatibility (Week 1-2)](#phase-1-backward-compatibility-week-1-2)
    - [Phase 2: UI Integration (Week 3-4)](#phase-2-ui-integration-week-3-4)
    - [Phase 3: Deprecation (Future)](#phase-3-deprecation-future)
  ...
  - [Future Enhancements](#future-enhancements)
    - [Version 1.1 (Future)](#version-11-future)
    - [Version 2.0 (Future)](#version-20-future)
  - [Success Metrics](#success-metrics)
    - [Adoption Metrics](#adoption-metrics)
    - [Performance Metrics](#performance-metrics)
    - [User Satisfaction](#user-satisfaction)
  - [References](#references)
  - [Appendix A: Complete Filter Reference](#appendix-a-complete-filter-reference)
    - [Clip Filters](#clip-filters)
    - [User/Creator Filters](#usercreator-filters)
