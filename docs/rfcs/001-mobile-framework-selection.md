...
- [RFC 001: Mobile Framework Selection](#rfc-001-mobile-framework-selection)
  - [Summary](#summary)
  - [Context](#context)
  - [Goals](#goals)
  - [Evaluation Criteria](#evaluation-criteria)
  - [Options Considered](#options-considered)
    - [Option 1: React Native + Expo (Recommended ✅)](#option-1-react-native--expo-recommended-)
    - [Option 2: Flutter](#option-2-flutter)
    - [Option 3: Native (Swift/Kotlin)](#option-3-native-swiftkotlin)
  - [Decision](#decision)
  ...
  - [Implementation Plan](#implementation-plan)
    ...
    - [Phase 4: Polish & Launch (Week 5-6)](#phase-4-polish--launch-week-5-6)
  ...
  - [Alternatives Rejected](#alternatives-rejected)
    - [Why not PWA only?](#why-not-pwa-only)
    - [Why not Capacitor?](#why-not-capacitor)
    - [Why not Ionic?](#why-not-ionic)
