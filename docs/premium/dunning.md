...
- [Dunning and Failed Payment Recovery](#dunning-and-failed-payment-recovery)
  - [Overview](#overview)
  - [Key Concepts](#key-concepts)
    - [Grace Period](#grace-period)
    - [Payment Failure States](#payment-failure-states)
  - [Workflow](#workflow)
    - [1. Payment Failure](#1-payment-failure)
    - [2. Payment Retry](#2-payment-retry)
    - [3. Grace Period Warnings](#3-grace-period-warnings)
    - [4. Grace Period Expiry](#4-grace-period-expiry)
    - [5. Payment Success (Recovery)](#5-payment-success-recovery)
  - [Email Notifications](#email-notifications)
    - [Payment Failed](#payment-failed)
    - [Payment Retry](#payment-retry)
    - [Grace Period Warning](#grace-period-warning)
    - [Subscription Downgraded](#subscription-downgraded)
  - [Database Schema](#database-schema)
    - [Payment Failures Table](#payment-failures-table)
    - [Dunning Attempts Table](#dunning-attempts-table)
    - [Subscriptions Table (Extended)](#subscriptions-table-extended)
  - [Scheduled Jobs](#scheduled-jobs)
    - [Grace Period Expiry Check](#grace-period-expiry-check)
    - [Grace Period Warnings](#grace-period-warnings)
