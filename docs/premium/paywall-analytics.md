...
- [Paywall Analytics Events](#paywall-analytics-events)
  - [Overview](#overview)
  - [Implementation](#implementation)
    - [Usage](#usage)
  - [Event Reference](#event-reference)
    - [1. Paywall Viewed](#1-paywall-viewed)
    - [2. Upgrade Clicked](#2-upgrade-clicked)
    - [3. Checkout Initiated](#3-checkout-initiated)
    - [4. Subscription Purchased](#4-subscription-purchased)
    - [5. Checkout Cancelled](#5-checkout-cancelled)
    - [6. Paywall Dismissed](#6-paywall-dismissed)
    - [7. Pricing Page Viewed](#7-pricing-page-viewed)
    - [8. Billing Period Changed](#8-billing-period-changed)
    - [9. Feature Gate Encountered](#9-feature-gate-encountered)
    - [10. Quota Limit Reached](#10-quota-limit-reached)
