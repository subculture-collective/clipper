...
- [Keyboard Shortcuts](#keyboard-shortcuts)
  ...
  - [Clip Interaction](#clip-interaction)
    ...
    - [Viewing Clip Details](#viewing-clip-details)
  - [Forms](#forms)
  ...
  - [Profile & Settings](#profile--settings)
    - [Tab Navigation in Profile](#tab-navigation-in-profile)
  ...
  - [Tips for Efficient Navigation](#tips-for-efficient-navigation)
    - [Using Skip Links](#using-skip-links)
