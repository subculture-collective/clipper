...
- [Tagging System Implementation](#tagging-system-implementation)
  - [Overview](#overview)
  ...
  - [Usage Examples](#usage-examples)
    - [Automatically tag a clip](#automatically-tag-a-clip)
    - [Add tags via API](#add-tags-via-api)
    - [Search tags](#search-tags)
    - [Get clips by tag](#get-clips-by-tag)
