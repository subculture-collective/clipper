...
- [User Settings and Account Management](#user-settings-and-account-management)
  - [Features](#features)
    - [Profile Management](#profile-management)
    - [Privacy Settings](#privacy-settings)
    - [Notification Preferences](#notification-preferences)
    - [Data Export (GDPR Compliance)](#data-export-gdpr-compliance)
    - [Account Deletion (GDPR Compliance)](#account-deletion-gdpr-compliance)
  - [Database Schema](#database-schema)
    - [user_settings Table](#user_settings-table)
    - [account_deletions Table](#account_deletions-table)
  - [Frontend Components](#frontend-components)
    - [SettingsPage Component](#settingspage-component)
