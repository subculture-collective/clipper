...
- [Engagement Metrics](#engagement-metrics)
  - [Overview](#overview)
  - [User Engagement Score](#user-engagement-score)
  ...
  - [Content Engagement](#content-engagement)
    - [Metrics](#metrics)
    - [Content Engagement Score](#content-engagement-score)
  - [Platform Health](#platform-health)
    ...
    - [Stickiness Ratio](#stickiness-ratio)
    - [Retention Rate by Cohort](#retention-rate-by-cohort)
    - [Churn Rate](#churn-rate)
  - [Calculation Rules](#calculation-rules)
    - [Rolling Windows](#rolling-windows)
    - [Weighting by Recency](#weighting-by-recency)
    - [Normalization to 0-100 Scale](#normalization-to-0-100-scale)
    - [Aggregation Frequency](#aggregation-frequency)
  - [API Endpoints](#api-endpoints)
    - [User Engagement](#user-engagement)
    - [Platform Health](#platform-health-1)
    - [Trending](#trending)
    - [Export](#export)
