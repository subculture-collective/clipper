...
- [Clipper Query Language Grammar v1.0.0](#clipper-query-language-grammar-v100)
  ...
  - [Examples with Parse Trees](#examples-with-parse-trees)
    - [Example 1: Simple Filter Query](#example-1-simple-filter-query)
    - [Example 2: Multiple Filters with Negation](#example-2-multiple-filters-with-negation)
    - [Example 3: Boolean OR Expression](#example-3-boolean-or-expression)
    - [Example 4: Grouped Expression](#example-4-grouped-expression)
    - [Example 5: Mixed Terms and Filters](#example-5-mixed-terms-and-filters)
    - [Example 6: Complex Query](#example-6-complex-query)
  ...
  - [Version History](#version-history)
    - [Version 1.0.0 (2025-11-09)](#version-100-2025-11-09)
