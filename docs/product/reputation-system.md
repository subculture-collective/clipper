...
- [User Reputation System](#user-reputation-system)
  - [Overview](#overview)
  ...
  - [Badge System](#badge-system)
    ...
    - [Badge Awarding](#badge-awarding)
  - [Karma System](#karma-system)
    - [Karma Sources](#karma-sources)
    - [Karma Permissions](#karma-permissions)
  - [Rank System](#rank-system)
  - [Trust Score](#trust-score)
  - [Engagement Score](#engagement-score)
  - [Usage Examples](#usage-examples)
    - [Check if User Can Perform Action](#check-if-user-can-perform-action)
    - [Award Badge Manually](#award-badge-manually)
    - [Check and Award Automatic Badges](#check-and-award-automatic-badges)
    - [Update User Activity](#update-user-activity)
  - [Testing](#testing)
