...
- [Query Language Examples and Test Cases](#query-language-examples-and-test-cases)
  - [Table of Contents](#table-of-contents)
  - [Basic Examples](#basic-examples)
    - [Free-Text Search](#free-text-search)
    - [Single Filter Queries](#single-filter-queries)
    - [Multiple Filter Queries](#multiple-filter-queries)
  ...
  - [Advanced Examples](#advanced-examples)
    ...
    - [Combined Free-Text and Filters](#combined-free-text-and-filters)
    - [Sorting](#sorting)
    - [Type Filtering](#type-filtering)
  - [Real-World Use Cases](#real-world-use-cases)
    - [Use Case 1: Find Recent Popular Content](#use-case-1-find-recent-popular-content)
    - [Use Case 2: Find Specific Content Type](#use-case-2-find-specific-content-type)
    - [Use Case 3: Multi-Game Search](#use-case-3-multi-game-search)
    - [Use Case 4: Creator Discovery](#use-case-4-creator-discovery)
    - [Use Case 5: Clean Family-Friendly Content](#use-case-5-clean-family-friendly-content)
    - [Use Case 6: Language-Specific Search](#use-case-6-language-specific-search)
    - [Use Case 7: Short Highlight Clips](#use-case-7-short-highlight-clips)
    - [Use Case 8: Specific Creator Search](#use-case-8-specific-creator-search)
    - [Use Case 9: Game + Multiple Tags](#use-case-9-game--multiple-tags)
    - [Use Case 10: Discovery Mode](#use-case-10-discovery-mode)
  - [Edge Cases](#edge-cases)
    - [Empty and Whitespace](#empty-and-whitespace)
