...
- [Discovery Lists Feature](#discovery-lists-feature)
  - [Overview](#overview)
  ...
  - [Maintenance](#maintenance)
    - [Updating Top Streamers List](#updating-top-streamers-list)
  - [Troubleshooting](#troubleshooting)
    - [No clips shown with top10k filter](#no-clips-shown-with-top10k-filter)
    - [Discussed sort showing wrong order](#discussed-sort-showing-wrong-order)
    - [Frontend toggle not working](#frontend-toggle-not-working)
