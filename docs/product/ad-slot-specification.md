...
- [Ad Slot Specification](#ad-slot-specification)
  ...
  - [Breakpoint Specifications](#breakpoint-specifications)
    - [Web Breakpoints](#web-breakpoints)
    - [Mobile App Breakpoints](#mobile-app-breakpoints)
  - [Fallback Rules](#fallback-rules)
    - [Empty Inventory Handling](#empty-inventory-handling)
    - [Fallback Priority](#fallback-priority)
    - [House Ad Creatives](#house-ad-creatives)
    - [Collapse Behavior by Slot Type](#collapse-behavior-by-slot-type)
  ...
  - [Implementation Guidelines](#implementation-guidelines)
    - [Frontend Integration (Web)](#frontend-integration-web)
    - [Mobile Integration (React Native)](#mobile-integration-react-native)
    - [Third-Party Ad Networks](#third-party-ad-networks)
