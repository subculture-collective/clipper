...
- [Mobile Submit Clip Flow - Implementation Documentation](#mobile-submit-clip-flow---implementation-documentation)
  - [Overview](#overview)
  - [Features](#features)
    - [1. Multi-Step Wizard UI](#1-multi-step-wizard-ui)
    - [2. Success View](#2-success-view)
    - [3. Error View](#3-error-view)
  ...
  - [API Backend Requirements](#api-backend-requirements)
