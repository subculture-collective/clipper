...
- [Mobile-First CSS Changes - Visual Examples](#mobile-first-css-changes---visual-examples)
  - [ClipCard Component](#clipcard-component)
    - [Before: Desktop-First Layout](#before-desktop-first-layout)
    - [After: Mobile-First Layout](#after-mobile-first-layout)
  - [Search Page Tabs](#search-page-tabs)
    - [Before: Fixed Horizontal Layout](#before-fixed-horizontal-layout)
    - [After: Responsive Layout](#after-responsive-layout)
  - [Profile Page Header](#profile-page-header)
    - [Before: Side-by-Side Only](#before-side-by-side-only)
    - [After: Stacked on Mobile](#after-stacked-on-mobile)
  - [Button Component Touch Targets](#button-component-touch-targets)
    - [Before: Inconsistent Heights](#before-inconsistent-heights)
    - [After: Guaranteed Minimums](#after-guaranteed-minimums)
  - [Typography Scaling](#typography-scaling)
    - [Before: Fixed Sizes with Large Jump](#before-fixed-sizes-with-large-jump)
    - [After: Progressive Enhancement](#after-progressive-enhancement)
  - [Container Padding](#container-padding)
    - [Before: Two-Step Padding](#before-two-step-padding)
    - [After: Four-Step Padding](#after-four-step-padding)
  - [Spacing Scale Comparison](#spacing-scale-comparison)
  - [Touch Target Examples](#touch-target-examples)
    - [Interactive Elements Comparison](#interactive-elements-comparison)
  ...
  - [Overflow Prevention](#overflow-prevention)
    - [Before: Possible Overflow](#before-possible-overflow)
    - [After: Overflow Protected](#after-overflow-protected)
