...
- [Deep Linking Test Cases](#deep-linking-test-cases)
  - [Prerequisites](#prerequisites)
  - [Test Cases](#test-cases)
    - [TC-1: Custom Scheme - Clip Detail](#tc-1-custom-scheme---clip-detail)
    - [TC-2: Universal Link - Clip Detail (iOS)](#tc-2-universal-link---clip-detail-ios)
    - [TC-3: App Link - Clip Detail (Android)](#tc-3-app-link---clip-detail-android)
    - [TC-4: Search Screen](#tc-4-search-screen)
    - [TC-5: Submit Clip Screen](#tc-5-submit-clip-screen)
    - [TC-6: Profile Screen](#tc-6-profile-screen)
    - [TC-7: Invalid Clip ID](#tc-7-invalid-clip-id)
    - [TC-8: Deep Link While App is Running](#tc-8-deep-link-while-app-is-running)
    - [TC-9: Deep Link from Background](#tc-9-deep-link-from-background)
    - [TC-10: Fallback to Web (App Not Installed)](#tc-10-fallback-to-web-app-not-installed)
    - [TC-11: .well-known File Accessibility](#tc-11-well-known-file-accessibility)
    - [TC-12: Multiple Deep Links in Sequence](#tc-12-multiple-deep-links-in-sequence)
    - [TC-13: Deep Link with Query Parameters](#tc-13-deep-link-with-query-parameters)
    - [TC-14: npx uri-scheme Testing](#tc-14-npx-uri-scheme-testing)
