...
- [OAuth PKCE Implementation Summary](#oauth-pkce-implementation-summary)
  ...
  - [Configuration](#configuration)
    - [App Configuration (`app.json`)](#app-configuration-appjson)
    - [Environment Variables](#environment-variables)
    - [Twitch App Configuration](#twitch-app-configuration)
  - [Backend Integration](#backend-integration)
    - [`POST /api/v1/auth/twitch/callback`](#post-apiv1authtwitchcallback)
  ...
  - [Troubleshooting](#troubleshooting)
    ...
    - [App doesn't redirect after Twitch auth](#app-doesnt-redirect-after-twitch-auth)
    - [Session doesn't persist](#session-doesnt-persist)
    - [API requests return 401 repeatedly](#api-requests-return-401-repeatedly)
