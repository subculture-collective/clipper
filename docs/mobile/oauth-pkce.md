...
- [OAuth PKCE Implementation](#oauth-pkce-implementation)
  - [Overview](#overview)
  - [How PKCE Works](#how-pkce-works)
    - [1. Code Verifier and Challenge](#1-code-verifier-and-challenge)
  ...
  - [Security Features](#security-features)
    - [1. Encrypted Storage](#1-encrypted-storage)
    - [2. CSRF Protection](#2-csrf-protection)
    - [3. Code Challenge Method](#3-code-challenge-method)
    - [4. Fallback Security](#4-fallback-security)
  - [Usage](#usage)
    - [Frontend Login Flow](#frontend-login-flow)
    - [Handling Callback](#handling-callback)
    - [Logout](#logout)
  - [Browser Compatibility](#browser-compatibility)
    - [Full Support (IndexedDB + Web Crypto)](#full-support-indexeddb--web-crypto)
    - [Fallback (sessionStorage)](#fallback-sessionstorage)
  - [Testing](#testing)
    - [Unit Tests](#unit-tests)
    - [Run Tests](#run-tests)
  - [Migration from Standard OAuth](#migration-from-standard-oauth)
  - [Security Considerations](#security-considerations)
    - [What PKCE Protects Against](#what-pkce-protects-against)
    - [What PKCE Doesn't Protect Against](#what-pkce-doesnt-protect-against)
    - [Best Practices](#best-practices)
  - [References](#references)
  - [Troubleshooting](#troubleshooting)
    - ["Invalid code verifier" Error](#invalid-code-verifier-error)
    - ["Invalid state parameter" Error](#invalid-state-parameter-error)
    - [Storage Not Working](#storage-not-working)
