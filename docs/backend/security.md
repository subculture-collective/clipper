...
- [Security Hardening Documentation](#security-hardening-documentation)
  - [Overview](#overview)
  - [Content Security Policy (CSP)](#content-security-policy-csp)
    - [Implementation](#implementation)
    - [Policy Details](#policy-details)
    - [Twitch Embed Compatibility](#twitch-embed-compatibility)
  ...
  - [Input Validation](#input-validation)
    ...
    - [Input Sanitization Utilities](#input-sanitization-utilities)
    - [Configuration](#configuration)
  - [Rate Limiting](#rate-limiting)
    - [Standard Rate Limiting](#standard-rate-limiting)
    - [Applied Rate Limits](#applied-rate-limits)
    - [Enhanced Rate Limiting](#enhanced-rate-limiting)
  ...
  - [Troubleshooting](#troubleshooting)
    ...
    - [Rate Limiting False Positives](#rate-limiting-false-positives)
    - [CSP Violations](#csp-violations)
    - [Abuse Detection False Positives](#abuse-detection-false-positives)
