...
- [Semantic Search Architecture](#semantic-search-architecture)
  ...
  - [Indexing Path](#indexing-path)
    - [Indexing Flow Diagram](#indexing-flow-diagram)
    - [Indexing Steps Explained](#indexing-steps-explained)
    - [Batch Indexing (Backfill)](#batch-indexing-backfill)
  - [Query Path](#query-path)
    - [Query Flow Diagram](#query-flow-diagram)
    - [Query Steps Explained](#query-steps-explained)
  ...
  - [Testing Strategy](#testing-strategy)
    ...
    - [Relevance Testing](#relevance-testing)
  - [Rollout Plan](#rollout-plan)
    - [Phase 1: Foundation (2 weeks)](#phase-1-foundation-2-weeks)
    - [Phase 2: Backfill (1 week)](#phase-2-backfill-1-week)
    - [Phase 3: Hybrid Search (2 weeks)](#phase-3-hybrid-search-2-weeks)
    - [Phase 4: Production (1 week)](#phase-4-production-1-week)
    - [Phase 5: Optimization (ongoing)](#phase-5-optimization-ongoing)
  - [Security Considerations](#security-considerations)
  - [Index Management and Versioning](#index-management-and-versioning)
