...
- [Clip Submission API - Developer Guide](#clip-submission-api---developer-guide)
  ...
  - [Quick Start](#quick-start)
    - [1. Fetch Clip Metadata](#1-fetch-clip-metadata)
    - [2. Submit the Clip](#2-submit-the-clip)
  - [Complete Workflow](#complete-workflow)
    - [End-to-End Clip Submission](#end-to-end-clip-submission)
    - [React Hook Example](#react-hook-example)
  - [cURL Examples](#curl-examples)
    - [Complete Workflow with cURL](#complete-workflow-with-curl)
    - [Individual cURL Examples](#individual-curl-examples)
  - [Error Handling](#error-handling)
    - [Common Error Responses](#common-error-responses)
    - [Error Handling in TypeScript](#error-handling-in-typescript)
  - [Rate Limits](#rate-limits)
  - [Best Practices](#best-practices)
    - [1. Always Validate Before Submitting](#1-always-validate-before-submitting)
    - [2. Handle Rate Limits Gracefully](#2-handle-rate-limits-gracefully)
    - [3. Cache Metadata Locally](#3-cache-metadata-locally)
    - [4. Provide User Feedback](#4-provide-user-feedback)
    - [5. Validate URLs Client-Side](#5-validate-urls-client-side)
  - [Troubleshooting](#troubleshooting)
    - [Problem: "Unauthorized" error](#problem-unauthorized-error)
    - [Problem: "Clip not found on Twitch"](#problem-clip-not-found-on-twitch)
    - [Problem: "Rate limit exceeded"](#problem-rate-limit-exceeded)
    - [Problem: "Insufficient karma"](#problem-insufficient-karma)
    - [Problem: "Duplicate clip"](#problem-duplicate-clip)
    - [Problem: Metadata fetch fails (502 error)](#problem-metadata-fetch-fails-502-error)
