...
const demoClip = {
    ...
    embed_url:
        'https://clips.twitch.tv/embed?clip=mock-clip-123&parent=localhost',
...
test.describe('Framework Demo - Page Object Model', () => {
     ...
     */
    test('should navigate to home page and verify elements', async ({
        homePage,
    }) => {
     ...
     * - Custom page methods
     */
    test('should search for clips using page object', async ({
        homePage,
        page,
    }) => {
        await homePage.goto();
     ...
     * - Page transitions
     */
    test('should navigate from home to clip detail', async ({
        homePage,
        page,
    }) => {
        await homePage.goto();
