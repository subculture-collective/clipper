...
export async function login(page: Page): Promise<void> {
  ...
  await page.waitForSelector(
    ...
    console.log('Login verification timeout - user may not be logged in');
  });
}
 ...
 */
export async function getAuthToken(page: Page, tokenKey: string = 'auth_token'): Promise<string | null> {
  try {
    ...
    const tokenCookie = cookies.find(cookie => 
      cookie.name === tokenKey || cookie.name === 'token' || cookie.name === 'jwt'
    );
 ...
 */
export async function saveAuthState(page: Page, outputPath: string): Promise<void> {
 ...
 */
export async function mockOAuthCallback(page: Page, mockTokens: AuthTokens): Promise<void> {
