...
export async function createClip(
    ...
    const defaultClip = {
        ...
        thumbnailUrl:
            clipData.thumbnailUrl || 'https://via.placeholder.com/640x360',
...
export async function createSubmission(
    ...
    const defaultSubmission = {
        ...
        description:
            submissionData.description || 'Test submission description',
    ...
    try {
        ...
        if (!response.ok()) {
            console.warn(
                'Failed to create submission via API, using mock data',
            );
            return {
