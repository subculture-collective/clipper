...
describe('SubmissionConfirmation', () => {
    ...
    it('renders success icon and message', () => {
        render(_jsx(SubmissionConfirmation, { submission: mockSubmission, onSubmitAnother: mockOnSubmitAnother }));
        expect(screen.getByText('Submission Successful!')).toBeInTheDocument();
        expect(screen.getByText('Your clip has been submitted for review')).toBeInTheDocument();
    });
    ...
    it('displays fallback to original title if custom title is not provided', () => {
        ...
        render(_jsx(SubmissionConfirmation, { submission: submissionWithoutCustomTitle, onSubmitAnother: mockOnSubmitAnother }));
    ...
    it('displays "Untitled" if no title is provided', () => {
        ...
        render(_jsx(SubmissionConfirmation, { submission: submissionWithoutTitle, onSubmitAnother: mockOnSubmitAnother }));
    ...
    it('displays creator name when broadcaster name is not available', () => {
        ...
        render(_jsx(SubmissionConfirmation, { submission: submissionWithoutBroadcaster, onSubmitAnother: mockOnSubmitAnother }));
    ...
    it('does not display tags section when no tags are provided', () => {
        ...
        render(_jsx(SubmissionConfirmation, { submission: submissionWithoutTags, onSubmitAnother: mockOnSubmitAnother }));
    ...
    it('displays approved status with success badge', () => {
        ...
        render(_jsx(SubmissionConfirmation, { submission: approvedSubmission, onSubmitAnother: mockOnSubmitAnother }));
    ...
    it('shows auto-approval message and clip link when status is approved', () => {
        ...
        expect(screen.getByText('Your clip has been automatically approved and is now live on the platform.')).toBeInTheDocument();
    ...
    it('renders responsive layout with mobile and desktop classes', () => {
        const { container } = render(_jsx(SubmissionConfirmation, { submission: mockSubmission, onSubmitAnother: mockOnSubmitAnother }));
