...
describe('FeedFilters', () => {
    ...
    describe('Sort options rendering', () => {
        it('renders all sort options', () => {
            render(_jsx(FeedFilters, { sort: "hot", onSortChange: mockOnSortChange, onTimeframeChange: mockOnTimeframeChange }));
        ...
        it('applies primary variant to different selected sort', () => {
            render(_jsx(FeedFilters, { sort: "new", onSortChange: mockOnSortChange, onTimeframeChange: mockOnTimeframeChange }));
            const hotButton = screen.getByRole('button', { name: 'Hot' });
            const newButton = screen.getByRole('button', { name: 'New' });
    ...
    describe('Sort option interaction', () => {
        ...
        it('calls onSortChange with correct value for each sort option', async () => {
            const user = userEvent.setup();
            render(_jsx(FeedFilters, { sort: "hot", onSortChange: mockOnSortChange, onTimeframeChange: mockOnTimeframeChange }));
            const sortOptions = ['hot', 'new', 'top', 'rising', 'discussed'];
    ...
    describe('Timeframe selector', () => {
        ...
        it('shows timeframe selector when sort is "top"', () => {
            render(_jsx(FeedFilters, { sort: "top", timeframe: "day", onSortChange: mockOnSortChange, onTimeframeChange: mockOnTimeframeChange }));
        ...
        it('applies primary variant to selected timeframe', () => {
            render(_jsx(FeedFilters, { sort: "top", timeframe: "week", onSortChange: mockOnSortChange, onTimeframeChange: mockOnTimeframeChange }));
