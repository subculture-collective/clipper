...
export function SEO({
  ...
  return (
    <Helmet>
      ...
      {twitterPlayerWidth && <meta name="twitter:player:width" content={twitterPlayerWidth} />}
      {twitterPlayerHeight && <meta name="twitter:player:height" content={twitterPlayerHeight} />}
