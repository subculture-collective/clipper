...
describe('UserAppealsStatus', () => {
  ...
  describe('Rendering', () => {
    ...
    it('displays empty state when no appeals', async () => {
      ...
      await waitFor(() => {
        expect(screen.getByText(/You haven't submitted any appeals yet/)).toBeInTheDocument();
      });
    });
  });
  ...
  describe('Appeal Details', () => {
    it('displays appeal information', async () => {
      ...
      await waitFor(() => {
        expect(screen.getByText(/Appeal for ban Action/)).toBeInTheDocument();
      });
  ...
  describe('Pending Appeals', () => {
    it('shows pending status message for pending appeals', async () => {
      ...
      await waitFor(() => {
        expect(
          screen.getByText(/Your appeal is being reviewed by our moderation team/)
        ).toBeInTheDocument();
      });
    });
  ...
  describe('Approved Appeals', () => {
    ...
    it('displays resolution for approved appeals', async () => {
      ...
      await waitFor(() => {
        expect(screen.getByText('You were correct, ban has been lifted')).toBeInTheDocument();
      });
    });
  ...
  describe('Rejected Appeals', () => {
    ...
    it('displays resolution for rejected appeals', async () => {
      ...
      await waitFor(() => {
        expect(screen.getByText('The original decision was correct')).toBeInTheDocument();
      });
    });
  ...
  describe('Error Handling', () => {
    ...
    it('displays error in alert component', async () => {
      ...
      await waitFor(() => {
        ...
        expect(alert).toHaveTextContent('Failed to load appeals');
      });
    });
  });
  ...
  describe('Missing Data Handling', () => {
    it('handles missing decision_action gracefully', async () => {
      ...
      await waitFor(() => {
        expect(screen.getByText(/Appeal for Unknown Action/)).toBeInTheDocument();
      });
    });
    ...
    it('does not display resolution section if not present', async () => {
      ...
      expect(screen.queryByText("Moderator's Note:")).not.toBeInTheDocument();
    });
  });
  ...
  describe('Accessibility', () => {
    it('has proper heading structure', async () => {
      ...
      await waitFor(() => {
        expect(screen.getByRole('heading', { name: 'My Appeals' })).toBeInTheDocument();
      });
    });
