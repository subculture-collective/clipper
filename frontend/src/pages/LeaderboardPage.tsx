...
import { LeaderboardTable, LeaderboardSummary } from '../components/reputation/LeaderboardTable';
import { LeaderboardResponse, LeaderboardType } from '../types/reputation';
    ...
    <div className="max-w-6xl mx-auto px-4 py-8">
      ...
      {!loading && !error && leaderboard && (
        <>
          {/* Top 3 Summary */}
          {page === 1 && (
            <LeaderboardSummary entries={leaderboard.entries} type={type} />
          )}
