...
describe('SearchPage - Sort Controls', () => {
    it('renders sort dropdown with proper theme-aware styling', () => {
        render(_jsx(QueryClientProvider, { client: queryClient, children: _jsx(BrowserRouter, { children: _jsx(SearchPage, {}) }) }));
    ...
    it('sort dropdown has focus-visible styles for accessibility', () => {
        ...
        const wrapper = ({ children }) => (_jsx(QueryClientProvider, { client: queryClient, children: _jsx(BrowserRouter, { initialEntries: ['/?q=test'], children: children }) }));
        render(_jsx(SearchPage, {}), { wrapper });
