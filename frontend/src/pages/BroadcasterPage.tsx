...
export function BroadcasterPage() {
  ...
  const followMutation = useMutation({
    ...
    onSuccess: () => {
      queryClient.invalidateQueries({ queryKey: ['broadcaster', broadcasterId] });
    ...
    return (
      <Container className="py-8">
        <div className="text-center text-muted-foreground py-12">
          <h2 className="text-2xl font-bold mb-2">Broadcaster Not Found</h2>
          <p>The broadcaster you're looking for doesn't exist or has no clips yet.</p>
        </div>
      </Container>
    );
  }
          ...
          <div className="flex flex-col md:flex-row items-start md:items-center gap-6 mb-6">
            ...
            <div className="flex-1">
              ...
              <div className="flex flex-wrap gap-6 text-sm">
                <div>
                  <span className="font-semibold">{profile.total_clips}</span>
                ...
                <div>
                  <span className="font-semibold">{profile.total_views.toLocaleString()}</span>
                  <span className="text-muted-foreground ml-1">Total Views</span>
                </div>
                <div>
                  <span className="font-semibold">{profile.avg_vote_score.toFixed(1)}</span>
            ...
            {clipsData.meta.total_pages > 1 && (
              <div className="flex justify-center gap-2">
                ...
                <Button
                  ...
                  disabled={page >= clipsData.meta.total_pages}
                >
                  Next
                </Button>
              </div>
