...
describe('TermsPage', () => {
  ...
  it('renders key terms sections', () => {
    ...
    expect(screen.getByText(/2\. Account Registration and Security/i)).toBeInTheDocument();
    expect(screen.getByText(/3\. Acceptable Use Policy/i)).toBeInTheDocument();
    expect(screen.getByText(/4\. Content and Intellectual Property/i)).toBeInTheDocument();
    expect(screen.getByText(/8\. Disclaimers and Limitation of Liability/i)).toBeInTheDocument();
  });
  ...
  it('has anchor IDs for navigation', () => {
    ...
    expect(container.querySelector('#account-registration')).toBeInTheDocument();
    expect(container.querySelector('#acceptable-use')).toBeInTheDocument();
    expect(container.querySelector('#content-licensing')).toBeInTheDocument();
  ...
  it('includes legal disclaimers', () => {
    ...
    const liabilityElements = screen.getAllByText(/Limitation of Liability/i);
  ...
  it('includes contact information', () => {
    ...
    expect(screen.getByText(/14\. Contact Information/i)).toBeInTheDocument();
  ...
  it('mentions dispute resolution', () => {
    ...
    expect(screen.getByText(/11\. Dispute Resolution and Arbitration/i)).toBeInTheDocument();
