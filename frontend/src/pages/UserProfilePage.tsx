...
import { UserPlus, UserMinus, Calendar, ChevronLeft, ChevronRight } from 'lucide-react';
...
export function UserProfilePage() {
    ...
    const { data: followersData } = useQuery({
        ...
        queryFn: () => fetchUserFollowers(userData!.id, pagination.followers, 20),
        enabled: !!userData?.id && activeTab === 'followers',
    });

    const { data: followingData } = useQuery({
        queryKey: ['user-following', userData?.id, pagination.following],
        queryFn: () => fetchUserFollowing(userData!.id, pagination.following, 20),
                                    ...
                                    {(pagination.activity > 1 || activityData.meta.has_next) && (
                                        <div className="flex justify-center gap-2 mt-6">
                                            <Button
                                                ...
                                                disabled={pagination.activity === 1}
                                                variant="outline"
                                                size="sm"
                                            >
                                                <ChevronLeft className="w-4 h-4 mr-1" />
                                            ...
                                            <Button
                                                onClick={() => handlePageChange('activity', pagination.activity + 1)}
                                                disabled={!activityData.meta.has_next}
                                                variant="outline"
                                                size="sm"
                                            >
                                                Next
                                    ...
                                    {(pagination.followers > 1 || followersData.meta.has_next) && (
                                        <div className="flex justify-center gap-2 mt-6">
                                            <Button
                                                ...
                                                disabled={pagination.followers === 1}
                                                variant="outline"
                                                size="sm"
                                            >
                                                <ChevronLeft className="w-4 h-4 mr-1" />
                                            ...
                                            <Button
                                                onClick={() => handlePageChange('followers', pagination.followers + 1)}
                                                disabled={!followersData.meta.has_next}
                                                variant="outline"
                                                size="sm"
                                            >
                                                Next
                                    ...
                                    {(pagination.following > 1 || followingData.meta.has_next) && (
                                        <div className="flex justify-center gap-2 mt-6">
                                            <Button
                                                ...
                                                disabled={pagination.following === 1}
                                                variant="outline"
                                                size="sm"
                                            >
                                                <ChevronLeft className="w-4 h-4 mr-1" />
                                            ...
                                            <Button
                                                onClick={() => handlePageChange('following', pagination.following + 1)}
                                                disabled={!followingData.meta.has_next}
                                                variant="outline"
                                                size="sm"
                                            >
                                                Next
