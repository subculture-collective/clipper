        ...
        <div className="bg-gradient-to-br from-purple-900/30 to-blue-900/30 rounded-lg p-6 mb-8 border border-purple-800">
          ...
          <ul className="space-y-3 text-gray-300">
            <li className="flex items-start gap-2">
              ...
              <span>
                <strong className="text-white">Explore without ads:</strong> Browse clips with a clean, uninterrupted experience
              </span>
            </li>
            <li className="flex items-start gap-2">
              <span className="text-purple-400 mt-1">→</span>
              <span>
                <strong className="text-white">Try advanced search:</strong> Use date ranges, view counts, and custom sorting
              </span>
            </li>
            <li className="flex items-start gap-2">
              <span className="text-purple-400 mt-1">→</span>
              <span>
                <strong className="text-white">Create collections:</strong> Organize your favorite clips into themed playlists
              </span>
            </li>
            <li className="flex items-start gap-2">
              <span className="text-purple-400 mt-1">→</span>
              <span>
                <strong className="text-white">Sync across devices:</strong> Your favorites are now synced in real-time
              </span>
            </li>
          </ul>
        </div>
