...
type StripeConfig struct {
	...
	ProYearlyPriceCents  int // Yearly price converted to monthly equivalent in cents (e.g., 833 for $99.99/year)
	SuccessURL           string
	CancelURL            string
}
...
func Load() (*Config, error) {
	...
	config := &Config{
		...
		Stripe: StripeConfig{
			...
			ProYearlyPriceCents:  getEnvInt("STRIPE_PRO_YEARLY_PRICE_CENTS", 833),   // Default: $99.99/year = $8.33/month
