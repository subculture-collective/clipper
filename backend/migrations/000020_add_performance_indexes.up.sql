...
-- Note: Using IF NOT EXISTS instead of CONCURRENTLY to allow execution within migration transactions
-- For production, consider creating these indexes manually with CONCURRENTLY to avoid table locks
